  ...
  try {
    if (req.method === 'GET') {
      ...
      if (id) {
        ...
        // ✅ CORREGIDO: Codificar nombre del archivo
        const fileNameEncoded = encodeURIComponent(archivo.nombre_archivo);
        
        // Configurar headers para descarga
        res.setHeader('Content-Type', archivo.tipo_archivo);
        res.setHeader('Content-Disposition', `attachment; filename="${fileNameEncoded}"`);
